  ...
  return (
    <div className="login-container">
      ...
      <input
        ...
        onChange={(e) =>
          setInputs((input) => ({ ...input, username: e.target.value }))
        }
      />
      <input
        className="text-input"
        ...
        placeholder="Email"
        onChange={(e) =>
          setInputs((input) => ({ ...input, email: e.target.value }))
        }
      />
      ...
      <div className="password-field">
        <input
          ...
          onChange={(e) =>
            setInputs((input) => ({ ...input, password: e.target.value }))
          }
        />
        {showPassword && (
      ...
      <input
        ...
        onChange={(e) =>
          setInputs((input) => ({ ...input, confirmPassword: e.target.value }))
        }
      />
      <button
        disabled={!checkForm}
